...
public enum ResolveTime {
    ...
    BEFORE_ATTACK("BEFORE_ATTACK", 36),
    AFTER_ATTACK("AFTER_ATTACK", 37),
    AFTER_ATTACKED("AFTER_ATTACKED", 38),
    ON_BATTLE_START("ON_BATTLE_START", 39),
    AFTER_DODGE("AFTER_DODGE", 40);
