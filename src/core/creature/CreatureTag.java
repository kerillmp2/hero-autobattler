...
public enum CreatureTag implements Tag {
    ...
    ADD_MANA_AFTER_ATTACK("ADD_MANA_AFTER_ATTACK", 9),
    DAMAGE_ALL_ENEMIES_AFTER_ATTACK("DAMAGE_ALL_ENEMIES_AFTER_ATTACK", 10),
    ADD_ARMOR_AFTER_TAKING_PHYSICAL_DAMAGE("ADD_ARMOR_AFTER_TAKING_PHYSICAL_DAMAGE", 11);
