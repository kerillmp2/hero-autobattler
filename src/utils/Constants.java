...
public enum Constants {
    ...
    BATTLEFIELD_VIEW_SIZE("BATTLEFIELD_VIEW_SIZE", 3, 140),
    SHOP_VIEW_SIZE("SHOP_VIEW_SIZE", 4, 140),
    ...
    PRINT_ENG_MESSAGES("PRINT_ENG_MESSAGES", 13, 1),
    PRINT_RU_MESSAGES("PRINT_RU_MESSAGES", 14, 0),
